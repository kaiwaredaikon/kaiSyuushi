...
import jp.co.kaiwaredaikon320.syushi.util.HolidayUtil;
...
public class DateInfo implements Parcelable {
    ...
    public DateInfo(int year, int month, int day) {
        ...
        this.isHoliday = HolidayUtil.isSunday(this.year, this.month,  this.day) || StrUtil.isNotEmpty(this.holidayName);
    }
    /**
     * コンストラクタ
    ...
    public Date createDate() {
        this.reportDate =
            new Date(this.year + "/" + this.month + "/" + this.day + " " + this.hour + ":" + this.minute);
        return this.reportDate;
    }

    /**
     * 内部の日付をYYMMDD形式で取得します
     * @return String YYMM形式の日付が戻ります
     */
    public String getYM() {
        return Integer.toString(this.year) + toTwoDigits(this.month);
    }
    ...
    public String getYMD() {
        return Integer.toString(this.year) + toTwoDigits(this.month) + toTwoDigits(this.day);
    }
    /**
