...
/**
 * This class provides a handy way to tie together the functionality of {@link VerticalDrawerLayout} and the framework
 * <code>ActionBar</code> to implement the recommended design for navigation drawers.
 * 
 * <p>
 * To use <code>ActionBarVerticalDrawerToggle</code>, create one in your Activity and call through to the following
 * methods corresponding to your Activity callbacks:
 * </p>
 * 
 * <ul>
 ...
 * 
 * <p>
 * Call {@link #syncState()} from your <code>Activity</code>'s {@link Activity#onPostCreate(android.os.Bundle)
 * onPostCreate} to synchronize the indicator with the state of the linked DrawerLayout after
 * <code>onRestoreInstanceState</code> has occurred.
 * </p>
 * 
 * <p>
 * <code>ActionBarVerticalDrawerToggle</code> can be used directly as a {@link VerticalDrawerLayout.DrawerListener}, or
 * if you are already providing your own listener, call through to each of the listener methods from your own.
 * </p>
 */
public class ActionBarVerticalDrawerToggle implements VerticalDrawerLayout.DrawerListener {
	 ...
	 * 
	 * <p>
	 * The given {@link Activity} will be linked to the specified {@link VerticalDrawerLayout}. The provided drawer
	 * indicator drawable will animate slightly off-screen as the drawer is opened, indicating that in the open state
	 * the drawer will move off-screen when pressed and in the closed state the drawer will move on-screen when pressed.
	 * </p>
	 * 
	 * <p>
	 ...
	 * @param openDrawerContentDescRes A String resource to describe the "open drawer" action for accessibility
	 * @param closeDrawerContentDescRes A String resource to describe the "close drawer" action for accessibility
	 */
	 ...
	 * 
	 * <p>
	 * This should be called from your <code>Activity</code>'s {@link Activity#onPostCreate(android.os.Bundle)
	 * onPostCreate} method to synchronize after the DrawerLayout's instance state has been restored, and any other time
	 * when the state may have diverged in such a way that the ActionBarVerticalDrawerToggle was not notified. (For
	 * example, if you stop forwarding appropriate drawer events for a period of time.)
	 * </p>
	 */
	 ...
	 * 
	 * <p>
	 * When the indicator is disabled, the <code>ActionBar</code> will revert to displaying the home-as-up indicator
	 * provided by the <code>Activity</code>'s theme in the <code>android.R.attr.homeAsUpIndicator</code> attribute
	 ...
	 * {@link Activity#onConfigurationChanged(android.content.res.Configuration) onConfigurationChanged} method.
	 * 
	 ...
	 * {@link Activity#onOptionsItemSelected(android.view.MenuItem) onOptionsItemSelected} method. If it returns true,
	 * your <code>onOptionsItemSelected</code> method should return true and skip further processing.
	 * 
	...
	/**
	 * {@link VerticalDrawerLayout.DrawerListener} callback method. If you do not use your ActionBarVerticalDrawerToggle
	 * instance directly as your DrawerLayout's listener, you should call through to this method from your own listener
	 * object.
	 * 
